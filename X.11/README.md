...
* 8 Modify the program from §X.11[3] to also compute the median.
...
* 10 Write a function rev() that takes a C-style string argument and reverses the characters in
...
* 14 Convert the desk calculator to use a symbol structure instead of using the static vari-
ables number_value and string_value .

---

* 15 Copy all even non-zero elements of an int[] into a vector<int> . Use a pointer and ++ for
the traversal.
